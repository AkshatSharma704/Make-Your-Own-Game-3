...
function preload(){
  ...
  weapon1_img = loadImage("images/Weapon_1.png");
}
...
function setup(){
    ...
    weapon = new Weapon(135,580);
    //creating player sprite
    launcher = new Launcher(weapon.body, {x: 200, y: 300});

    snake1 = new Snake(1320,590);
